            ...
            tiers: [
                {
                    ...
                    features: [
                        ...
                        "Optional Website Maintenance for ($50/month)",
                    ],
                },
                {
                    name: "Pro Tier",
                    ...
                    features: [
                        ...
                        "Free maintenance and support for one week",
                        "Custom Website Domain Setup",
                        "No Watermark",
                        "Optional Website Maintenance for ($65/month)",
                    ],
                },
                {
                    name: "Elite Tier",
                    ...
                    features: [
                        ...
                        "Image compression for faster loading time",
                        "Free maintenance and support for one month",
                        "Website SEO and analytics setup",
                        "Custom Website Domain Setup",
                        "No Watermark",
                        "Optional Website Maintenance for ($80/month)",
                    ],
                },
                {
                    name: "Corporate Tier",
                    ...
                    features: [
                        ...
                        "E-commerce functionality or advanced interactions",
                        "Image compression for faster loading time",
                        "Free maintenance and support for two months",
                        "Website SEO and analytics setup",
                        "No Watermark",
                        "Custom Website Domain Setup",
                        "Free Promotional Flyer",
                        "Optional Website Maintenance for ($100/month)",
                    ],
                },
            ],
        },
