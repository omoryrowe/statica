        ...
        <div className="bg-gradient-to-r from-transparent via-gray-800/50 py-12 md:py-20">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p
              ...
              data-aos-delay={200}
            >
              Statica’s designs are crafted to inspire and connect. We
              seamlessly blend creativity with strategy, delivering
              solutions that leave lasting impressions. Let us elevate
              your brand with visuals that speak volume and turn your
              ideas into impactful designs today!
            </p>
