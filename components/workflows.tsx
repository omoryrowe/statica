...
export default function Workflows() {
  return (
    <section className="relative -mt-10">
      <div className="border-t py-4 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.400/.25),transparent)1] md:py-8"></div>
          ...
          <div className="mx-auto max-w-3xl pb-12 text-center md:pb-20">
            <div className="inline-flex items-center gap-3 pb-3 before:h-px before:w-8 before:bg-gradient-to-r before:from-transparent before:to-indigo-200/50 after:h-px after:w-8 after:bg-gradient-to-l after:from-transparent after:to-indigo-200/50">
              <span className="inline-flex bg-gradient-to-r from-indigo-500 to-indigo-200 bg-clip-text text-transparent">
                Where creativity meets brand-defining impact
              </span>
            </div>
            ...
            >
              Why choose Statica? Because with us, your vision takes center stage. We listen, innovate,
              and collaborate to ensure every design reflects your unique identity and goals. Our
              skilled founder combines technical expertise with artistic ingenuity to create designs
              that not only stand out but also resonate with your audience.
            </p>
          </div>
          {/* Spotlight items */}
            ...
            >
              <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-gray-950 after:absolute after:inset-0 after:bg-gradient-to-br after:from-gray-900/50 after:via-gray-800/25 after:to-gray-900/50">
                ...
                <div className="p-6">
                  ...
                  <p className="text-white">
                    Bringing your creative ideas to life with custom designs in Adobe Photoshop.
                  </p>
                </div>
              </div>
            </a>
